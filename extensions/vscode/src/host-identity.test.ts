...
// Real T-ACC runs on POSIX (the maintainer's Mac); Windows parsers are unit-verified
...
// The exact tree probed live on the maintainer's Electron host (the v0.3 spike):

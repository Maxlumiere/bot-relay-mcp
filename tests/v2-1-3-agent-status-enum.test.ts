...
describe("v2.1.3 I6 — schema v2_5 migration + defaults", () => {
  it("schema version is current post-migration (ADR-0036 agent_bindings bumped to 25; ADR-0011 message-disposition 24; ADR-0005 orphan-cleanup 23; Phase A server_version 22; ADR-0002 agent-class 21; ADR-0003 auth latency 20; v2.15.1 stale-status cleanup 19, v2.13.0 presence liveness 18, v2.12.0 pending-vs-history 17, Tether PID-handshake 16)", () => {

...
- **external reviewer** — external review that flagged the original four items (/mcp Host-check, SameSite+CSRF, per-IP rate limits, audit preview retention doc).
